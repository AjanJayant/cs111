...
multiboot_start:
  ...
  100013:	9d                   	popf   
	call start
  100014:	e8 8b 01 00 00       	call   1001a4 <start>
  100019:	90                   	nop
...
00100060 <_generic_int_handler>:
  ...
  10006c:	54                   	push   %esp
	call interrupt
  10006d:	e8 c1 00 00 00       	call   100133 <interrupt>
...
schedule(void)
{
  ...
  10009f:	a1 b0 7b 10 00       	mov    0x107bb0,%eax
  1000a4:	8b 10                	mov    (%eax),%edx

	if (scheduling_algorithm == 0)
  1000a6:	a1 b4 7b 10 00       	mov    0x107bb4,%eax
  ...
  1000bd:	83 b8 ec 71 10 00 01 	cmpl   $0x1,0x1071ec(%eax)
  1000c4:	75 ee                	jne    1000b4 <schedule+0x18>
				run(&proc_array[pid]);
  1000c6:	83 ec 0c             	sub    $0xc,%esp
  1000c9:	05 a4 71 10 00       	add    $0x1071a4,%eax
  1000ce:	eb 52                	jmp    100122 <schedule+0x86>
  ...
  1000d0:	83 f8 02             	cmp    $0x2,%eax
  1000d3:	75 5c                	jne    100131 <schedule+0x95>
		for(i = 1; i < NPROCS; i++) {
  ...
  1000d5:	83 3d 48 72 10 00 03 	cmpl   $0x3,0x107248
  1000dc:	7f 05                	jg     1000e3 <schedule+0x47>
  1000de:	ba 01 00 00 00       	mov    $0x1,%edx
  1000e3:	83 3d 9c 72 10 00 03 	cmpl   $0x3,0x10729c
  1000ea:	7f 05                	jg     1000f1 <schedule+0x55>
  1000ec:	ba 02 00 00 00       	mov    $0x2,%edx
  1000f1:	83 3d f0 72 10 00 03 	cmpl   $0x3,0x1072f0
  1000f8:	7f 05                	jg     1000ff <schedule+0x63>
  1000fa:	ba 03 00 00 00       	mov    $0x3,%edx
  1000ff:	83 3d 44 73 10 00 03 	cmpl   $0x3,0x107344
  100106:	7f 05                	jg     10010d <schedule+0x71>
  100108:	ba 04 00 00 00       	mov    $0x4,%edx
				is_valid = 1;
				priority_pid = i;
			}
		}
                if(proc_array[priority_pid].p_state == P_RUNNABLE)
  10010d:	6b c2 54             	imul   $0x54,%edx,%eax
  100110:	83 b8 ec 71 10 00 01 	cmpl   $0x1,0x1071ec(%eax)
  100117:	8d 80 a4 71 10 00    	lea    0x1071a4(%eax),%eax
  10011d:	75 09                	jne    100128 <schedule+0x8c>
                	run(&proc_array[priority_pid]);
  10011f:	83 ec 0c             	sub    $0xc,%esp
  100122:	50                   	push   %eax
  100123:	e8 9d 03 00 00       	call   1004c5 <run>
               	 else
		// If it isn't runnable, set priority to value which is too high
                	proc_array[priority_pid].p_priority = 6;
  100128:	c7 40 50 06 00 00 00 	movl   $0x6,0x50(%eax)
  10012f:	eb a4                	jmp    1000d5 <schedule+0x39>
  100131:	eb fe                	jmp    100131 <schedule+0x95>
...
interrupt(registers_t *reg)
{
  ...
  100134:	a1 b0 7b 10 00       	mov    0x107bb0,%eax
  100139:	b9 11 00 00 00       	mov    $0x11,%ecx
 *
 *****************************************************************************/
...
interrupt(registers_t *reg)
{
  10013e:	56                   	push   %esi
  10013f:	53                   	push   %ebx
  100140:	8b 5c 24 10          	mov    0x10(%esp),%ebx
	// Save the current process's register state
	// into its process descriptor
	current->p_registers = *reg;
  100144:	8d 78 04             	lea    0x4(%eax),%edi
  100147:	89 de                	mov    %ebx,%esi
  100149:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)

	switch (reg->reg_intno) {
  10014b:	8b 53 28             	mov    0x28(%ebx),%edx
  10014e:	83 fa 31             	cmp    $0x31,%edx
  100151:	74 1f                	je     100172 <interrupt+0x3f>
  100153:	77 0c                	ja     100161 <interrupt+0x2e>
  100155:	83 fa 20             	cmp    $0x20,%edx
  100158:	74 43                	je     10019d <interrupt+0x6a>
  10015a:	83 fa 30             	cmp    $0x30,%edx
  10015d:	74 0e                	je     10016d <interrupt+0x3a>
  10015f:	eb 41                	jmp    1001a2 <interrupt+0x6f>
  100161:	83 fa 32             	cmp    $0x32,%edx
  100164:	74 23                	je     100189 <interrupt+0x56>
  100166:	83 fa 33             	cmp    $0x33,%edx
  100169:	74 29                	je     100194 <interrupt+0x61>
  10016b:	eb 35                	jmp    1001a2 <interrupt+0x6f>

	case INT_SYS_YIELD:
		// The 'sys_yield' system call asks the kernel to schedule
		// the next process.
		schedule();
  10016d:	e8 2a ff ff ff       	call   10009c <schedule>
  ...
  100172:	a1 b0 7b 10 00       	mov    0x107bb0,%eax
		current->p_exit_status = reg->reg_eax;
  100177:	8b 53 1c             	mov    0x1c(%ebx),%edx
		// The application stored its exit status in the %eax register
		// before calling the system call.  The %eax register has
		// changed by now, but we can read the application's value
		// out of the 'reg' argument.
		// (This shows you how to transfer arguments to system calls!)
		current->p_state = P_ZOMBIE;
  10017a:	c7 40 48 03 00 00 00 	movl   $0x3,0x48(%eax)
		current->p_exit_status = reg->reg_eax;
  100181:	89 50 4c             	mov    %edx,0x4c(%eax)
		schedule();
  ...
  100189:	a1 b0 7b 10 00       	mov    0x107bb0,%eax
  10018e:	8b 53 1c             	mov    0x1c(%ebx),%edx
  100191:	89 50 50             	mov    %edx,0x50(%eax)
		#endif
		run(current);
  ...
  100197:	50                   	push   %eax
  100198:	e8 28 03 00 00       	call   1004c5 <run>
	...
	case INT_CLOCK:
		...
		schedule();
  10019d:	e8 fa fe ff ff       	call   10009c <schedule>
  1001a2:	eb fe                	jmp    1001a2 <interrupt+0x6f>
...
start(void)
{
  1001a4:	55                   	push   %ebp
		...
		proc->p_priority = 5 -i;
  1001a5:	bd 04 00 00 00       	mov    $0x4,%ebp
 *
 *****************************************************************************/
...
start(void)
{
  1001b3:	53                   	push   %ebx
	...
	for (i = 0; i < NPROCS; i++) {
		proc_array[i].p_pid = i;
		proc_array[i].p_state = P_EMPTY;
  1001b4:	bb f8 71 10 00       	mov    $0x1071f8,%ebx
 *
 *****************************************************************************/
...
start(void)
{
  1001b9:	83 ec 0c             	sub    $0xc,%esp
	...
	segments_init();
  1001bc:	e8 e3 00 00 00       	call   1002a4 <segments_init>
	interrupt_controller_init(0);
  1001c1:	83 ec 0c             	sub    $0xc,%esp
  1001c4:	6a 00                	push   $0x0
  1001c6:	e8 d4 01 00 00       	call   10039f <interrupt_controller_init>
	console_clear();
  1001cb:	e8 58 02 00 00       	call   100428 <console_clear>

	// Initialize process descriptors as empty
	memset(proc_array, 0, sizeof(proc_array));
  1001d0:	83 c4 0c             	add    $0xc,%esp
  1001d3:	68 a4 01 00 00       	push   $0x1a4
  1001d8:	6a 00                	push   $0x0
  1001da:	68 a4 71 10 00       	push   $0x1071a4
  1001df:	e8 24 04 00 00       	call   100608 <memset>
	for (i = 0; i < NPROCS; i++) {
		proc_array[i].p_pid = i;
		proc_array[i].p_state = P_EMPTY;
  1001e4:	83 c4 10             	add    $0x10,%esp
	...
	for (i = 0; i < NPROCS; i++) {
		proc_array[i].p_pid = i;
  1001e7:	c7 05 a4 71 10 00 00 	movl   $0x0,0x1071a4
  1001ee:	00 00 00 
		proc_array[i].p_state = P_EMPTY;
  1001f1:	c7 05 ec 71 10 00 00 	movl   $0x0,0x1071ec
  1001f8:	00 00 00 
	console_clear();
	...
	for (i = 0; i < NPROCS; i++) {
		proc_array[i].p_pid = i;
  1001fb:	c7 05 f8 71 10 00 01 	movl   $0x1,0x1071f8
  100202:	00 00 00 
		proc_array[i].p_state = P_EMPTY;
  100205:	c7 05 40 72 10 00 00 	movl   $0x0,0x107240
  10020c:	00 00 00 
	console_clear();
	...
	for (i = 0; i < NPROCS; i++) {
		proc_array[i].p_pid = i;
  10020f:	c7 05 4c 72 10 00 02 	movl   $0x2,0x10724c
  100216:	00 00 00 
		proc_array[i].p_state = P_EMPTY;
  100219:	c7 05 94 72 10 00 00 	movl   $0x0,0x107294
  100220:	00 00 00 
	console_clear();
	...
	for (i = 0; i < NPROCS; i++) {
		proc_array[i].p_pid = i;
  100223:	c7 05 a0 72 10 00 03 	movl   $0x3,0x1072a0
  10022a:	00 00 00 
		proc_array[i].p_state = P_EMPTY;
  10022d:	c7 05 e8 72 10 00 00 	movl   $0x0,0x1072e8
  100234:	00 00 00 
	console_clear();
	...
	for (i = 0; i < NPROCS; i++) {
		proc_array[i].p_pid = i;
  100237:	c7 05 f4 72 10 00 04 	movl   $0x4,0x1072f4
  10023e:	00 00 00 
		proc_array[i].p_state = P_EMPTY;
  100241:	c7 05 3c 73 10 00 00 	movl   $0x0,0x10733c
  100248:	00 00 00 
	for (i = 1; i < NPROCS; i++) {
  ...
  10024e:	53                   	push   %ebx
  10024f:	e8 88 02 00 00       	call   1004dc <special_registers_init>
  ...
  100254:	58                   	pop    %eax
  100255:	5a                   	pop    %edx
  100256:	8d 43 34             	lea    0x34(%ebx),%eax
		...
		// Set ESP
		proc->p_registers.reg_esp = stack_ptr;
  100259:	89 7b 40             	mov    %edi,0x40(%ebx)
		program_loader(i - 1, &proc->p_registers.reg_eip);
		...
		proc->p_priority = 5 -i;
  10025c:	81 c7 00 00 10 00    	add    $0x100000,%edi
  ...
  100262:	50                   	push   %eax
  100263:	56                   	push   %esi
  100264:	e8 af 02 00 00       	call   100518 <program_loader>

		// Mark the process as runnable!
		proc->p_state = P_RUNNABLE;

		proc->p_priority = 5 -i;
  100269:	89 e8                	mov    %ebp,%eax
		proc_array[i].p_pid = i;
		proc_array[i].p_state = P_EMPTY;
	}
  ...
  100271:	c7 43 48 01 00 00 00 	movl   $0x1,0x48(%ebx)
		...
		proc->p_priority = 5 -i;
  100278:	89 43 50             	mov    %eax,0x50(%ebx)
  10027b:	83 c3 54             	add    $0x54,%ebx
		proc_array[i].p_pid = i;
		proc_array[i].p_state = P_EMPTY;
	}
	...
	// Set up process descriptors (the proc_array[])
	for (i = 1; i < NPROCS; i++) {
  10027e:	83 fe 04             	cmp    $0x4,%esi
  100281:	75 c8                	jne    10024b <start+0xa7>
	#if SCHEDULE_ALGO == 2
  ...
  100286:	68 f8 71 10 00       	push   $0x1071f8
		proc->p_priority = 5 -i;
	}
  ...
  10028b:	c7 05 00 80 19 00 00 	movl   $0xb8000,0x198000
  100292:	80 0b 00 
	#if SCHEDULE_ALGO == 1
	...
	#if SCHEDULE_ALGO == 2
	scheduling_algorithm = 2;
  100295:	c7 05 b4 7b 10 00 02 	movl   $0x2,0x107bb4
  10029c:	00 00 00 
	#endif

	// Switch to the first process.
	run(&proc_array[1]);
  10029f:	e8 21 02 00 00       	call   1004c5 <run>
...
segments_init(void)
{
  ...
  1002a4:	b8 48 73 10 00       	mov    $0x107348,%eax
...
segments_init(void)
{
  ...
  1002c5:	88 15 3c 10 10 00    	mov    %dl,0x10103c
	...
	for (i = 0; i < sizeof(interrupt_descriptors) / sizeof(gatedescriptor_t); i++)
		SETGATE(interrupt_descriptors[i], 0,
  1002cb:	ba b0 73 10 00       	mov    $0x1073b0,%edx
segments_init(void)
{
	int i;
...
segments_init(void)
{
  ...
  1002ee:	c7 05 4c 73 10 00 00 	movl   $0x180000,0x10734c
  1002f5:	00 18 00 
	kernel_task_descriptor.ts_ss0 = SEGSEL_KERN_DATA;
  1002f8:	66 c7 05 50 73 10 00 	movw   $0x10,0x107350
  1002ff:	10 00 
	...
	for (i = 0; i < sizeof(interrupt_descriptors) / sizeof(gatedescriptor_t); i++)
		SETGATE(interrupt_descriptors[i], 0,
  100301:	66 89 0c c5 b0 73 10 	mov    %cx,0x1073b0(,%eax,8)
  100308:	00 
  ...
  100327:	b8 1a 00 10 00       	mov    $0x10001a,%eax
	...
	for (i = INT_SYS_YIELD; i < INT_SYS_YIELD + 10; i++)
		SETGATE(interrupt_descriptors[i], 0,
  10032c:	ba b0 73 10 00       	mov    $0x1073b0,%edx
	for (i = 0; i < sizeof(interrupt_descriptors) / sizeof(gatedescriptor_t); i++)
		SETGATE(interrupt_descriptors[i], 0,
			SEGSEL_KERN_CODE, default_int_handler, 0);
	...
	// The clock interrupt gets special handling
	SETGATE(interrupt_descriptors[INT_CLOCK], 0,
  100331:	66 a3 b0 74 10 00    	mov    %ax,0x1074b0
  100337:	c1 e8 10             	shr    $0x10,%eax
  10033a:	66 a3 b6 74 10 00    	mov    %ax,0x1074b6
  100340:	b8 30 00 00 00       	mov    $0x30,%eax
  100345:	66 c7 05 b2 74 10 00 	movw   $0x8,0x1074b2
  10034c:	08 00 
  10034e:	c6 05 b4 74 10 00 00 	movb   $0x0,0x1074b4
  100355:	c6 05 b5 74 10 00 8e 	movb   $0x8e,0x1074b5
  ...
  10036a:	66 89 0c c5 b0 73 10 	mov    %cx,0x1073b0(,%eax,8)
  100371:	00 
...
run(process_t *proc)
{
  1004c5:	8b 44 24 04          	mov    0x4(%esp),%eax
	current = proc;
  1004c9:	a3 b0 7b 10 00       	mov    %eax,0x107bb0
...
#define NUMBUFSIZ 20
  ...
  10071a:	b9 84 0a 10 00       	mov    $0x100a84,%ecx
  ...
  1007f7:	68 8c 0a 10 00       	push   $0x100a8c
  ...
  10082b:	55                   	push   %ebp
  10082c:	68 8c 0a 10 00       	push   $0x100a8c
  ...
  100839:	55                   	push   %ebp
  10083a:	68 a0 0a 10 00       	push   $0x100aa0
  ...
  100862:	55                   	push   %ebp
  100863:	68 8c 0a 10 00       	push   $0x100a8c
...
#define NUMBUFSIZ 20
  ...
  100a52:	c3                   	ret    
			...
			if (*flagc == '\0')
				break;
			flags |= (1 << (flagc - flag_chars));
  100a53:	81 e9 84 0a 10 00    	sub    $0x100a84,%ecx
